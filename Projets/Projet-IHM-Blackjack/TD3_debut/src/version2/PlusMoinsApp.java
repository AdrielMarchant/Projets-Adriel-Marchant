...
public class PlusMoinsApp extends Application {
	private final IntegerProperty valeurReference = new SimpleIntegerProperty(20);
	...
	public void start(Stage primaryStage) {
		...
		try {
			...
			ctrl.setPropertiersCompteur(this.valeurReference);
	...
	public void stop() {
		System.out.println("A la fin la valeur est "+this.valeurReference.getValue());
