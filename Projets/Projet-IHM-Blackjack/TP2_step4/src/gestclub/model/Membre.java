...
public class Membre {
	...
	public String toString() {
		switch (this.etat) {
			case Prospect:
				return nom+" "+prenom+" est un prospect depuis le "+dateInscription.toString();
			case Membre:
				return nom+" "+prenom+" est un membre depuis le "+dateInscription.toString();
			case Ancien:
				return nom+" "+prenom+" est n'est plus membre depuis le "+dateInscription.toString();
			default:
