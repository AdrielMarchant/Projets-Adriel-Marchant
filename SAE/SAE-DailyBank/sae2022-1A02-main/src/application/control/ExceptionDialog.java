...
public class ExceptionDialog {
	...
	/**
	 * Lance le dialogue d'exception quand une erreur est rencontré avec le stacktrace dans la zone de texte
	 * @param _parentStage Stage père à hériter
	 * @param _dbstate
	 * @param ae
	 */
