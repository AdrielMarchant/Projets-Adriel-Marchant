...
public class DailyBankMainFrameController implements Initializable {
	...
	/*
	 * fonction qui affiche la scène et qui attend 
	 */
	...
	/*
	 * fonction qui renvoi vers la fonction closeWindow quand l'utilisateur souhaite fermer la fenêtre et qui lie les boutons Conn et Deconn a des propritétés de visibilitées
	 */
	...
	/*
	 * fonction FXML qui revoie vers actionQuitterBd qui permet de quitter l'application
	 */
	@FXML
	private void doQuit() {
	...
	/*
	 * fonction qui ouvre une fenêtre d'aide
	 */
	@FXML
	...
	/*
	 * fonction FXML qui permet à l'utilisateur de se connecter 
	 */
	@FXML
	...
	/*
	 * fonction FXML qui permet à l'utilisateur de se déconnnecter 
	 */
	@FXML
	...
	/*
	 * fonction qui permet de valider l'état des composants 
	 */
	...
	/*
	 * fonction FXML qui permet d'ouvrir la gestion de compte du client 
	 */
	@FXML
	...
	/*
	 * fonction FXML qui permet d'ouvir la gestion de compte de l'employée 
	 */
	@FXML
