...
public class DailyBankMainFrame extends Application {
	...
	/**
	 * S'éxecute après le launch de l'Application, charge le dailybankmainframe.fxml
	 * Le controlleur DailyBankMainFrameController est donc aussi pris en compte
	 */
	@Override
	...
	/**
	 * ferme la connexion avec la bd et initialise les variables de session à zéro
	 */
	...
	/**
	 * Ouvre le dialogue d'acces à la session et te connecte
	 */
	public void login() {
	...
	/**
	 * accessible que si l login est effectué, ouvre le dialogue de gestion de clients
	 */
