...
public class OperationsManagement {
    ...
    public Operation enregistrerVirement() {
		...
		OperationVirementPane oep = new OperationVirementPane(this.primaryStage, this.dbs);
		Operation op = oep.doOperationVirementDialog(this.compteConcerne, CategorieOperation.TRANSFERT);
